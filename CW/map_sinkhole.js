...
const floorPositions = [
    ...
    { x: 16, y: 0, z: 0 }, { x: 20, y: 0, z: 0 }, 
    // { x: 24, y: 0, z: 0 }, { x: 28, y: 0, z: 0 },
    { x: 32, y: 0, z: 0 }, { x: 36, y: 0, z: 0 },
...
///// 싱크홀 추가 /////
// { x: 24, y: 0, z: 0 }, { x: 28, y: 0, z: -30 } 위치에
const sinkHolePositions = [
    // { x: 23, y: 0, z: -3, scaleX: , scaleY: 이용!}, { x: 23, y: 0, z: -2 }, { x: 23, y: 0, z: -1 }, { x: 23, y: 0, z: 0 },
...
export { floors, pillars, walls, obstacles, goal, pillarPositions,
    steps, bigwalls, bigWallPositions, smallfloors, sinkHoles, conePositions };